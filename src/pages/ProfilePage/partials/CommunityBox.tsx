...
function CommunityBox() {
  return (
    <div className='flex flex-col gap-4'>
      ...
      <Card
        size='small'
        className='h-[220px] overflow-auto bg-inherit border-none'
      >
        <List
          size='small'
